              ...
              <form action="">
                <div className="mb-4">
                  ...
                  <input
                    ...
                    name="name"
                    id="name"
                    className="font-extrabold shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  />
                </div>
                <div className="mb-4">
                  <label
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    name="email"
                    id="email"
                    className=" font-extrabold shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline"
                  />
                </div>
                <div className="mb-4 relative ">
                  <button
                    disabled
                    type="submit"
                    className="cursor-not-allowed bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline absolute right-0 "
                  >
                    Edit Profile
                  </button>
                </div>
            ...
            <div className="grid grid-cols-12 grid-rows-4 gap-4">
              <div className="col-start-1 col-end-13 md:col-start-9 md:col-end-13 flex items-center justify-center md:justify-end">
                ...
                <div className="relative h-[5rem] w-[5rem] bg-amber-400 border rounded-full ml-5 mr-0 my-5 shadow-md">
                  <h1 className="absolute left-[50%] top-[50%] tr text-xl font-medium translate-x-[-50%] translate-y-[-50%]">
                    {data?.totalScore}
                  </h1>
                </div>
              </div>
